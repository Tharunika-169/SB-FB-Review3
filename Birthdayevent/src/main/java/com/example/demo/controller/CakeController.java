...
public class CakeController {
	...
	CakeService sser;
		...
		@GetMapping("sort1/{flavor}")
		public List<CakeEntity> getsortinfo(@PathVariable String flavor){
			return sser.sortinfo(flavor);
		}
		...
		//query
		@GetMapping("showquerycakes/{cakeid}/{flavor}")
		public 	List<CakeEntity> showcakedetails(@PathVariable int cakeid,@PathVariable String flavor)
		{
			return sser.getcake(cakeid, flavor);
		}

...
public interface CakeRepo extends JpaRepository<CakeEntity, Integer>{
	...
	@Query(value="select * from Cake where cakeid=:cakeid or flavor=:flavor",nativeQuery=true)
	public List<CakeEntity> getcakeinfo(@Param("cakeid") int cakeid,@Param("flavor") String fl);
